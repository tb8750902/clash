...
dns:
  ...
  fallback:
    ...
    - tls://dns.google
proxies:
  - { name: "abc", type: ss, server: "beijinghao.xyz", port: 8080, password: "787ab299-29fd-4b07-9d05-3825ed3599cf", cipher: "aes-128-gcm" }


proxy-groups:
  - {name: "🎯 总模式", type: select, proxies: ["Ⓜ️ 延迟最低", "Ⓜ️ 负载均衡", "Ⓜ️ 故障切换", "♻️ 手动切换", "DIRECT"]}
  - {name: "Ⓜ️ 延迟最低", type: url-test, proxies: ["abc"], url: "https://www.gstatic.com/generate_204", interval: 300}
  - {name: "Ⓜ️ 故障切换", type: fallback, proxies: ["abc"], url: "https://www.gstatic.com/generate_204", interval: 300}
  - {name: "Ⓜ️ 负载均衡", type: load-balance, proxies: ["abc"], url: "https://www.gstatic.com/generate_204", interval: 300}
  - {name: "♻️ 手动切换", type: select, proxies: ["abc"]}
  - {name: "♻️ 手动切换1", type: select, proxies: ["abc"]}
  - {name: "♻️ 手动切换2", type: select, proxies: ["abc"]}
  - {name: "♻️ 手动切换3", type: select, proxies: ["abc"]}
...
# Baidu
  ...
  - DOMAIN-SUFFIX,ashifen.com,⛔ 应用拦截
  ...
  #- DOMAIN-SUFFIX,ufosdk.baidu.com,⛔ 应用拦截
...
#Steam
  - DOMAIN,cdn.mileweb.cs.steampowered.com.8686c.com,🎮 游戏平台
...
# Japonx
  ...
  - DOMAIN,upos-hz-mirrorakam.akamaized.net,⛩ 日韩媒体
  - DOMAIN,ds-linear-abematv.akamaized.net,⛩ 日韩媒体
  - DOMAIN,ds-vod-abematv.akamaized.net,⛩ 日韩媒体
  - DOMAIN,linear-abematv.akamaized.net,⛩ 日韩媒体
...
# HBO
  - DOMAIN,44wilhpljf.execute-api.ap-southeast-1.amazonaws.com,🌏 港台媒体
  - DOMAIN,bcbolthboa-a.akamaihd.net,🌏 港台媒体
  - DOMAIN,cf-images.ap-southeast-1.prod.boltdns.net,🌏 港台媒体
  - DOMAIN,dai3fd1oh325y.cloudfront.net,🌏 港台媒体
  - DOMAIN,hboasia1-i.akamaihd.net,🌏 港台媒体
  - DOMAIN,hboasia2-i.akamaihd.net,🌏 港台媒体
  - DOMAIN,hboasia3-i.akamaihd.net,🌏 港台媒体
  - DOMAIN,hboasia4-i.akamaihd.net,🌏 港台媒体
  - DOMAIN,hboasia5-i.akamaihd.net,🌏 港台媒体
  - DOMAIN,players.brightcove.net,🌏 港台媒体
  - DOMAIN,s3-ap-southeast-1.amazonaws.com,🌏 港台媒体
...
# BBC
  ...
  - DOMAIN-SUFFIX,bbc.in,🌍 国外媒体
  - DOMAIN-SUFFIX,bbcchinese.com,🌍 国外媒体
...
# GFW list
  ...
  - DOMAIN-SUFFIX,periscope.tv,🇺🇳 国外网站
  ...
  - DOMAIN-SUFFIX,twitpic.com,🇺🇳 国外网站
...
# Amazon
  - DOMAIN-SUFFIX,amazon.co.jp,🇺🇳 国外网站
  - DOMAIN-SUFFIX,amazon.com,🇺🇳 国外网站
  - IP-CIDR,13.32.0.0/15,🇺🇳 国外网站,no-resolve
  - IP-CIDR,13.35.0.0/17,🇺🇳 国外网站,no-resolve
  - IP-CIDR,18.184.0.0/15,🇺🇳 国外网站,no-resolve
  - IP-CIDR,18.208.0.0/13,🇺🇳 国外网站,no-resolve
  - IP-CIDR,18.232.0.0/14,🇺🇳 国外网站,no-resolve
  - IP-CIDR,52.58.0.0/15,🇺🇳 国外网站,no-resolve
  - IP-CIDR,52.74.0.0/16,🇺🇳 国外网站,no-resolve
  - IP-CIDR,52.77.0.0/16,🇺🇳 国外网站,no-resolve
  - IP-CIDR,52.84.0.0/15,🇺🇳 国外网站,no-resolve
  - IP-CIDR,52.200.0.0/13,🇺🇳 国外网站,no-resolve
  - IP-CIDR,54.93.0.0/16,🇺🇳 国外网站,no-resolve
  - IP-CIDR,54.156.0.0/14,🇺🇳 国外网站,no-resolve
  - IP-CIDR,54.226.0.0/15,🇺🇳 国外网站,no-resolve
  - IP-CIDR,54.230.156.0/22,🇺🇳 国外网站,no-resolve
...
#  - DOMAIN-SUFFIX,ajax.aspnetcdn.com,🇨🇳 国内网站
#  - DOMAIN-SUFFIX,code.jquery.com,🇨🇳 国内网站
